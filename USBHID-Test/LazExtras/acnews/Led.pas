...
begin
  {$I led_icon.lrs}
  RegisterComponents('Club AC-News',[TLed]);
end;

constructor TLed.Create(anOwner:TComponent);
begin
...
procedure TLed.SetBounds(aLeft, aTop, aWidth, aHeight: Integer);
begin
  Inherited ;
...
procedure TLed.UpdateBmpBuffer;
...
procedure TLed.SetBGColor(value: TColor);
begin
...
procedure TLed.SetBorderColor(value: TColor);
begin
...
procedure TLed.SetLedOnColor(value: TColor);
begin
...
procedure TLed.SetLedOffColor(value: TColor);
begin
...
procedure TLed.SetBorder(value: TBorderType);
begin
...
procedure TLed.SetBorderMargin(value: integer);
begin
