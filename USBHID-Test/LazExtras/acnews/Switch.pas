...
uses
  Windows, Messages, Classes, SysUtils, LResources, Forms, Controls, Graphics, Dialogs;
...
begin
  {$I switch_icon.lrs}
  RegisterComponents('Club AC-News',[TSwitch]);
end;

constructor TSwitch.Create(anOwner:TComponent);
begin
...
procedure TSwitch.Free;
begin
  FBmpBuffer.Free;
  Inherited Free;
end;

procedure TSwitch.SetBounds(aLeft, aTop, aWidth, aHeight: Integer);
begin
  Inherited ;
...
procedure TSwitch.UpdateBmpBuffer;
...
procedure TSwitch.SetSwitchStyle(value: TSwitchStyle);
begin
...
procedure TSwitch.SetBGColor(value: TColor);
begin
...
procedure TSwitch.SetBorderColor(value: TColor);
begin
...
procedure TSwitch.SetButtonBorderColor(value: TColor);
begin
...
procedure TSwitch.SetDisabledColor(value: TColor);
begin
...
procedure TSwitch.SetLitOnColor(value: TColor);
begin
...
procedure TSwitch.SetLitOffColor(value: TColor);
begin
...
procedure TSwitch.SetBorder(value: TBorderType);
begin
...
procedure TSwitch.SetButtonBorder(value: TBorderType);
begin
...
procedure TSwitch.SetHorzMargin(value: integer);
begin
...
procedure TSwitch.SetVertMargin(value: integer);
begin
...
procedure TSwitch.SetSwitchOn(value: boolean);
begin
...
procedure TSwitch.SetOrientation(value: TSwitchOrientation);
var
  oldVal: integer;
begin
